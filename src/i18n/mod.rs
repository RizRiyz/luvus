...
static KO: Catalog = Catalog {
    ...
    menu: "메뉴",
    copied: "클립보드에 복사됨",
    sidebar_full: "사이드바가 가득 참; 먼저 독을 하나 끄세요",
