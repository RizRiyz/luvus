...
static PT: Catalog = Catalog {
    ...
    board_start: "iniciar",
    board_release: "recolocar na fila",
...
static FR: Catalog = Catalog {
    ...
    board_release: "remettre en attente",
