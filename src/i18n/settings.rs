...
pub struct Catalog {
    ...
    pub keys_direct_shortcuts: &'static str,
    pub keys_prefix_commands: &'static str,
...
pub static EN: Catalog = Catalog {
    ...
    keys_direct_shortcuts: "Direct shortcuts",
    keys_prefix_commands: "Prefix commands",
    keys_prefix: "Prefix",
    keys_preset: "Preset",
...
pub static ID: Catalog = Catalog {
    ...
    keys_direct_shortcuts: "Pintasan langsung",
    keys_prefix_commands: "Perintah berprefiks",
    keys_prefix: "Prefiks",
    keys_preset: "Preset",
...
pub static ZH: Catalog = Catalog {
    ...
    keys_direct_shortcuts: "直接快捷键",
    keys_prefix_commands: "前缀命令",
    keys_prefix: "前缀键",
    keys_preset: "预设",
...
pub static JA: Catalog = Catalog {
    ...
    keys_direct_shortcuts: "ダイレクトショートカット",
    keys_prefix_commands: "プレフィックスコマンド",
    keys_prefix: "プレフィックス",
    keys_preset: "プリセット",
...
pub static KO: Catalog = Catalog {
    ...
    keys_direct_shortcuts: "직접 단축키",
    keys_prefix_commands: "접두사 명령",
    keys_prefix: "접두사",
    keys_preset: "프리셋",
