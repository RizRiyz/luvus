...
pub struct Catalog {
    ...
    pub key_click_branch: &'static str,
...
pub static ES: Catalog = Catalog {
    ...
    key_prefix_twice: "{prefix} ×2", key_space: "Espacio", key_arrows: "flechas", key_shift_arrow: "Shift+flecha", key_drag: "arrastrar", key_shift_drag: "Shift+arrastrar", key_click: "clic", key_right_click: "clic derecho", key_wheel: "rueda", key_drag_divider: "arrastrar divisor", key_click_branch: "clic en rama", key_tap_pane: "tocar panel",
    ...
    key_reference_descriptions: [
        ...
        &["enfocar un panel o activar una fila / botón", "menú contextual de panel, espacio, agente o pestaña", "desplazar historial del panel o una lista", "redimensionar la división", "abrir la pestaña Git de ese espacio", "ampliar con toque / móvil"],
    ],
...
pub static PT: Catalog = Catalog {
    ...
    key_prefix_twice: "{prefix} ×2", key_space: "Espaço", key_arrows: "setas", key_shift_arrow: "Shift+seta", key_drag: "arrastar", key_shift_drag: "Shift+arrastar", key_click: "clique", key_right_click: "clique direito", key_wheel: "roda", key_drag_divider: "arrastar divisor", key_click_branch: "clicar no ramo", key_tap_pane: "tocar painel",
    ...
    key_reference_descriptions: [
        ...
        &["focar um painel ou ativar uma linha / botão", "menu de contexto de painel, espaço, agente ou aba", "rolar histórico do painel ou uma lista", "redimensionar a divisão", "abrir a aba Git desse espaço", "ampliar por toque / móvel"],
    ],
...
pub static FR: Catalog = Catalog {
    ...
    key_prefix_twice: "{prefix} ×2", key_space: "Espace", key_arrows: "flèches", key_shift_arrow: "Shift+flèche", key_drag: "glisser", key_shift_drag: "Shift+glisser", key_click: "clic", key_right_click: "clic droit", key_wheel: "molette", key_drag_divider: "glisser le séparateur", key_click_branch: "clic sur branche", key_tap_pane: "toucher le volet",
    ...
    key_reference_descriptions: [
        ...
        &["cibler un volet ou activer une ligne / un bouton", "menu contextuel de volet, espace, agent ou onglet", "faire défiler l'historique du volet ou une liste", "redimensionner la division", "ouvrir l'onglet Git de cet espace", "agrandir par toucher / mobile"],
    ],
...
pub static DE: Catalog = Catalog {
    ...
    key_prefix_twice: "{prefix} ×2", key_space: "Leertaste", key_arrows: "Pfeile", key_shift_arrow: "Shift+Pfeil", key_drag: "ziehen", key_shift_drag: "Shift+ziehen", key_click: "Klick", key_right_click: "Rechtsklick", key_wheel: "Mausrad", key_drag_divider: "Teiler ziehen", key_click_branch: "Branch anklicken", key_tap_pane: "Bereich antippen",
    ...
    key_reference_descriptions: [
        ...
        &["Bereich fokussieren oder Zeile / Schaltfläche aktivieren", "Kontextmenü für Bereich, Arbeitsbereich, Agent oder Tab", "Bereichsverlauf oder Liste scrollen", "Teilung vergrößern", "Git-Tab dieses Arbeitsbereichs öffnen", "per Touch / mobil zoomen"],
    ],
