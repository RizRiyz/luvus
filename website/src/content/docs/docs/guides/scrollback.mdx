...
Drag across a pane to select. Release requests a copy; the *Copied to Clipboard*
toast appears only after a native clipboard helper confirms success. Luvus requests both your native OS clipboard (`pbcopy` / `wl-copy` /
