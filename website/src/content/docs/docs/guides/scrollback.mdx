...
unmarked. Press **`Ctrl-U`** while editing to clear the query without leaving
search. Matches are highlighted in place like FILE search: the current
word uses the accent color, and other visible hits use amber. Press
