...
[UHP method reference](/docs/reference/api/). For opt-in browser inspection,
see [Experimental Web Access](/docs/guides/web-access/). That Tailcat/WASM flow
is a reference adapter, not a UHP requirement.
