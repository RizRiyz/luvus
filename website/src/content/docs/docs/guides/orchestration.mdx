...
and leaves the task unclaimed. Multiline prompts and progress notes remain
multiline in task storage; their line boundaries are folded into one safe
paragraph only when they become part of a shell launch command.
