...
| Tab | What's there |
|---|---|
| **General** | **Open files with** (read-only or an editor you have installed, see [Browsing & Opening Files](/docs/guides/files/)), then a **Notify** section: **sound on done** and **sound on blocked**, both off by default, plus a **Test sound** row to hear it first |
...
| **Layout** | pane gaps, pane titles, resume-into-workspace behavior, sidebar docks, DIFF layout and limits, and `[Top] [Bottom] [Off]` placement for every [Luvus Bar](/docs/guides/bar/) widget |
...
| **Language** | the UI and human CLI information in 8 languages (en · es · pt · fr · de · id · zh · ja), swapped live; command syntax, JSON, and UHP remain canonical |
