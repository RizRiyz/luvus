...
| Tab | What's there |
|---|---|
| **General** | **Open files with** (read-only or an editor you have installed, see [Browsing & Opening Files](/docs/guides/files/)), then a **Notify** section with Retro, Soft, and Pulse sound styles, separate done and blocked toggles, and a test row for each cue |
