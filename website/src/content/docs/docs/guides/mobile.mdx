...
- new tab, open workspace, Settings, Mission Control, update information, and
  Exit;
...
Exit appears after Changelog and behaves like `Ctrl+Space q`: it detaches the
current client while the persistent server and its panes keep running.
