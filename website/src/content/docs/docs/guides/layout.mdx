...
A file path opens **in luvus**, not in some other app. It goes through exactly the
same path as clicking the file in the FILES tree, so it respects your
**Settings → General → Open files with** choice: the built-in read-only viewer by
default, or your terminal editor if you set one.
