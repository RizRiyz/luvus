...
current client. A stopped named session offers **Delete**, with confirmation,
to remove its saved state. The current session cannot be stopped from this menu,
and the default session cannot be deleted.
