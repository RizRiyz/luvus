...
| `agents_this_workspace` | scope the AGENTS dock to the active workspace when multiple workspaces are open; defaults to `false` and is independent of `agents_active_only` |
