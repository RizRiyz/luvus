...
same action menu as FILES: choose a native read-only tab, an editor, or the desktop
application. Actions target the result's workspace. Plain `a` remains query text.
