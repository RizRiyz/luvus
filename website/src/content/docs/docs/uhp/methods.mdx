...
currently focused pane. Pane IDs accept an unsigned 32-bit JSON integer or
its decimal string form; malformed or out-of-range values fail with
`invalid_request` before any mutation.
