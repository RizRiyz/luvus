...
`worktree.create` and TUI creation. Provider selection is host configuration,
not a per-request executable or command parameter. The workspace must belong to
